# Embedded file name: /usr/lib/enigma2/python/Plugins/Extensions/Infopanel/CamStart.py
...
config.softcam.restartAttempts = ConfigSelection([('0', _('0 (disabled)')),
 ('1', _('1')),
 ('3', _('3')),
 ('5', _('5 (default)')),
 ('10', _('10'))], '5')
config.softcam.restartTime = ConfigSelection([('5', _('5')),
 ('10', _('10 (default)')),
 ('20', _('20')),
 ('30', _('30')),
 ('60', _('60')),
 ('120', _('120')),
 ('240', _('240'))], '10')
config.softcam.camstartMode = ConfigSelection([('0', _('Python Camstarter (default)')), ('1', _('Init.d'))], '0')
